...
with DAG(
    ...
    federal_information_processing_standard_county_extractor = KubernetesPodOperator(
        ...
        cmds=['python', 'task.py', '{{ task_instance_key_str }}'],
        env_from=etl_config,
        env=dict(TASK_WRAPPER_CLASS='datalabs.etl.http.extract.HTTPFileExtractorTask'),
        do_xcom_push=True,
        is_delete_operator_pod=True,
        in_cluster=True,
    ...
    federal_information_processing_standard_county_transformer = KubernetesPodOperator(
        ...
        cmds=['python', 'task.py', '{{ task_instance_key_str }}'],
        env_from=etl_config,
        env=dict(TASK_WRAPPER_CLASS='datalabs.etl.oneview.reference.transform.FederalInformationProcessingStandardCountyTransformerTask'),
        do_xcom_push=True,
        is_delete_operator_pod=True,
        in_cluster=True,
    ...
    core_based_statistical_area_extractor = KubernetesPodOperator(
        ...
        cmds=['python', 'task.py', '{{ task_instance_key_str }}'],
        env_from=etl_config,
        env=dict(TASK_WRAPPER_CLASS='datalabs.etl.http.extract.HTTPUnicodeTextFileExtractorTask'),
        do_xcom_push=True,
        is_delete_operator_pod=True,
        in_cluster=True,
    ...
    specialty_merge_transformer = KubernetesPodOperator(
        ...
        cmds=['python', 'task.py', '{{ task_instance_key_str }}'],
        env_from=etl_config,
        env=dict(TASK_WRAPPER_CLASS='datalabs.etl.oneview.reference.transform.SpecialtyMergeTransformerTask'),
        do_xcom_push=True,
        is_delete_operator_pod=True,
        in_cluster=True,
    ...
    residency_extractor = KubernetesPodOperator(
        ...
        env=dict(TASK_CLASS='datalabs.etl.sftp.extract.SFTPUnicodeTextFileExtractorTask'),
        do_xcom_push=True,
        is_delete_operator_pod=True,
        in_cluster=True,
    ...
    iqvia_transformer = KubernetesPodOperator(
        ...
        cmds=['python', 'task.py', '{{ task_instance_key_str }}'],
        env_from=etl_config,
        env=dict(TASK_WRAPPER_CLASS='datalabs.etl.oneview.iqvia.transform.IQVIATransformerTask'),
        do_xcom_push=True,
        is_delete_operator_pod=True,
        in_cluster=True,
    ...
    credentialing_main_transformer = KubernetesPodOperator(
        ...
        cmds=['python', 'task.py', '{{ task_instance_key_str }}'],
        env_from=etl_config,
        env=dict(TASK_WRAPPER_CLASS='datalabs.etl.oneview.credentialing.transform.CredentialingTransformerTask'),
        do_xcom_push=True,
        is_delete_operator_pod=True,
        in_cluster=True,
    ...
    credentialing_addresses_extractor = KubernetesPodOperator(
        ...
        cmds=['python', 'task.py', '{{ task_instance_key_str }}'],
        env_from=[etl_config, sftp],
        env=dict(TASK_CLASS='datalabs.etl.sftp.extract.SFTPFileExtractorTask'),
        do_xcom_push=True,
        is_delete_operator_pod=True,
        in_cluster=True,
    ...
    credentialing_addresses_transformer = KubernetesPodOperator(
        ...
        cmds=['python', 'task.py', '{{ task_instance_key_str }}'],
        env_from=etl_config,
        env=dict(TASK_WRAPPER_CLASS='datalabs.etl.transform.PassThroughTransformerTask'),
        do_xcom_push=True,
        is_delete_operator_pod=True,
        in_cluster=True,
    ...
    credentialing_merge_transformer = KubernetesPodOperator(
        ...
        cmds=['python', 'task.py', '{{ task_instance_key_str }}'],
        env_from=etl_config,
        env=dict(TASK_WRAPPER_CLASS='datalabs.etl.oneview.credentialing.transform.CredentialingFinalTransformerTask'),
        do_xcom_push=True,
        is_delete_operator_pod=True,
        in_cluster=True,
    ...
    physician_race_ethnicity_extractor = KubernetesPodOperator(
        ...
        cmds=['python', 'task.py', '{{ task_instance_key_str }}'],
        env_from=[etl_config,sftp],
        env=dict(TASK_WRAPPER_CLASS='datalabs.etl.sftp.extract.SFTPUnicodeTextFileExtractorTask'),
        do_xcom_push=True,
        is_delete_operator_pod=True,
        in_cluster=True,
    ...
    physician_race_ethnicity_transformer = KubernetesPodOperator(
        ...
        cmds=['python', 'task.py', '{{ task_instance_key_str }}'],
        env_from=etl_config,
        env=dict(TASK_WRAPPER_CLASS='datalabs.etl.oneview.race_ethnicity.transform.RaceEthnicityTransformerTask'),
        do_xcom_push=True,
        is_delete_operator_pod=True,
        in_cluster=True,
    ...
    credentialing_customer_institution_transformer = KubernetesPodOperator(
        ...
        cmds=['python', 'task.py', '{{ task_instance_key_str }}'],
        env_from=etl_config,
        env=dict(TASK_WRAPPER_CLASS='datalabs.etl.oneview.link.transform.CredentialingCustomerInstitutionTransformerTask'),
        do_xcom_push=True,
        is_delete_operator_pod=True,
        in_cluster=True,
    ...
    credentialing_customer_business_transformer = KubernetesPodOperator(
        ...
        cmds=['python', 'task.py', '{{ task_instance_key_str }}'],
        env_from=etl_config,
        env=dict(TASK_WRAPPER_CLASS='datalabs.etl.oneview.link.transform.CredentialingCustomerBusinessTransformerTask'),
        do_xcom_push=True,
        is_delete_operator_pod=True,
        in_cluster=True,
    ...
    residency_program_physician_transformer = KubernetesPodOperator(
        ...
        cmds=['python', 'task.py', '{{ task_instance_key_str }}'],
        env_from=etl_config,
        env=dict(TASK_WRAPPER_CLASS='datalabs.etl.oneview.link.transform.ResidencyProgramPhysicianTransformerTask'),
        do_xcom_push=True,
        is_delete_operator_pod=True,
        in_cluster=True,
