...
class Physician(BASE):
    ...
    specialty = relationship("Specialty", foreign_keys="[Physician.primary_specialty, Physician.secondary_specialty]",
                             backref=backref("physician", cascade="all, delete-orphan"))
