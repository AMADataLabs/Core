...
class Physician(Base):
    ...
    core_based_statistical_area = sa.Column(sa.String, sa.ForeignKey("core_based_statistical_area.id"))
    ...
    type_of_practice = sa.Column(sa.String, sa.ForeignKey("type_of_practice.id"))
    present_employment = sa.Column(sa.String, sa.ForeignKey("present_employment.id"))
    primary_specialty = sa.Column(sa.String, sa.ForeignKey("specialty.id"))
    secondary_specialty = sa.Column(sa.String, sa.ForeignKey("specialty.id"))
    major_professional_activity = sa.Column(sa.String, sa.ForeignKey("major_professional_activity.id"))
