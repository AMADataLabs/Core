...
class PPD(Base):
    ...
    region = sa.Column(sa.Integer, nullable=False)
    division = sa.Column(sa.Integer, nullable=False)
    ...
    block_group = sa.Column(sa.Integer, nullable=False)
    msa_population_size = sa.Column(sa.String(1), nullable=False)
    micro_metro_ind = sa.Column(sa.Integer, nullable=False)
    cbsa = sa.Column(sa.String, nullable=False)
    cbsa_div_ind = sa.Column(sa.Integer, nullable=False)
    mo_do_code = sa.Column(sa.Integer, nullable=False)
    ...
    top_cd = sa.Column(sa.Integer, nullable=False)
    pe_cd = sa.Column(sa.Integer, nullable=False)
    ...
    pra_exp_dt = sa.Column(sa.Integer, nullable=False)
    ...
    year_in_program = sa.Column(sa.Integer, nullable=False)
    post_graduate_year = sa.Column(sa.Integer, nullable=False)
    gme_spec_1 = sa.Column(sa.String, nullable=False)
    gme_spec_2 = sa.Column(sa.String(2), nullable=False)
    training_type = sa.Column(sa.Integer, nullable=False)
