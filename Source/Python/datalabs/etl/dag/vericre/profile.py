...
if feature.enabled("SYNC_PROFILES"):
    (
        ...
        >> DAG.STANDARDIZE_DATES_ABMS
        >> DAG.CREATE_AGGREGATED_ABMS
        >> DAG.CREATE_AMA_PROFILE_TABLE
    )
    (
        DAG.EXTRACT_AMA_PHYSICIAN_PROFILES
        >> DAG.STANDARDIZE_DATES_DEA
        >> DAG.CREATE_AGGREGATED_DEA
        >> DAG.CREATE_AMA_PROFILE_TABLE
    )
    (
        DAG.EXTRACT_AMA_PHYSICIAN_PROFILES
        >> DAG.STANDARDIZE_DATES_DEMOG
        >> DAG.CREATE_AGGREGATED_DEMOG
        >> DAG.SPLIT_DEMOGRAPHICS
        >> DAG.CREATE_AMA_PROFILE_TABLE
    )
    (
        DAG.EXTRACT_AMA_PHYSICIAN_PROFILES
        >> DAG.STANDARDIZE_DATES_LICENSE
        >> DAG.CREATE_AGGREGATED_LICENSES
        >> DAG.CREATE_AMA_PROFILE_TABLE
    )
    (
        DAG.EXTRACT_AMA_PHYSICIAN_PROFILES
        >> DAG.STANDARDIZE_DATES_MED_SCH
        >> DAG.CREATE_AGGREGATED_MED_SCH
        >> DAG.CREATE_AMA_PROFILE_TABLE
    )
    (
        DAG.EXTRACT_AMA_PHYSICIAN_PROFILES
        >> DAG.STANDARDIZE_DATES_MED_TRAIN
        >> DAG.CREATE_AGGREGATED_MED_TRAIN
        >> DAG.CREATE_AMA_PROFILE_TABLE
    )
    (
        DAG.EXTRACT_AMA_PHYSICIAN_PROFILES
        >> DAG.STANDARDIZE_DATES_NPI
        >> DAG.CREATE_AGGREGATED_NPI
        >> DAG.CREATE_AMA_PROFILE_TABLE
    )
    (
        DAG.EXTRACT_AMA_PHYSICIAN_PROFILES
        >> DAG.STANDARDIZE_DATES_SANCTIONS
        >> DAG.CREATE_AGGREGATED_SANCTIONS
        >> DAG.CREATE_AMA_PROFILE_TABLE
    )
