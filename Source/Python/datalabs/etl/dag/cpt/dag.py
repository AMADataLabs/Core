...
CPTDAG.CREATE_RELEASE_TYPES >> CPTDAG.CREATE_RELEASE_TABLE

CPTDAG.CREATE_CODE_TABLE >> CPTDAG.CREATE_RELEASE_CODE_MAPPING_TABLE
CPTDAG.CREATE_RELEASE_TABLE >> CPTDAG.CREATE_RELEASE_CODE_MAPPING_TABLE

CPTDAG.CREATE_CODE_TABLE >> CPTDAG.CREATE_SHORT_DESCRIPTOR_TABLE
CPTDAG.CREATE_CODE_TABLE >> CPTDAG.CREATE_MEDIUM_DESCRIPTOR_TABLE
CPTDAG.CREATE_CODE_TABLE >> CPTDAG.CREATE_LONG_DESCRIPTOR_TABLE
...
CPTDAG.CREATE_MODIFIER_TYPE_TABLE >> CPTDAG.CREATE_MODIFIER_TABLE
CPTDAG.CREATE_MODIFIER_TYPE_TABLE >> CPTDAG.LOAD_MODIFIER_TYPE_TABLE

CPTDAG.LOAD_MODIFIER_TYPE_TABLE >> CPTDAG.LOAD_DESCRIPTOR_TABLES
...
CPTDAG.CREATE_PLA_DETAILS_TABLE >> CPTDAG.CREATE_MANUFACTURER_CODE_MAPPING_TABLE
CPTDAG.CREATE_MANUFACTURER_TABLE >> CPTDAG.CREATE_MANUFACTURER_CODE_MAPPING_TABLE

CPTDAG.CREATE_PLA_DETAILS_TABLE >> CPTDAG.CREATE_LAB_CODE_MAPPING_TABLE
CPTDAG.CREATE_LAB_TABLE >> CPTDAG.CREATE_LAB_CODE_MAPPING_TABLE

CPTDAG.CREATE_LAB_TABLE >> CPTDAG.LOAD_LAB_TABLE

CPTDAG.CREATE_MANUFACTURER_TABLE >> CPTDAG.LOAD_MANUFACTURER_TABLE
...
CPTDAG.LOAD_MANUFACTURER_TABLE >> CPTDAG.LOAD_PLA_DETAILS_TABLE
CPTDAG.LOAD_CODE_TABLE >> CPTDAG.LOAD_PLA_DETAILS_TABLE
