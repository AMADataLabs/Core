...
class OneViewDAG(DAG):
    ...
    LOAD_IQVIA_BUSINESS_TABLE: ORMLoaderTask
    ...
    EXTRACT_CREDENTIALING_ORDER: Repeat(JDBCExtractorTask, 2)
...
# OneViewDAG.sequence('EXTRACT_IQVIA_BUSINESS', 6)
# OneViewDAG.parallel('EXTRACT_IQVIA_BUSINESS', 'CREATE_BUSINESS_TABLE', 6)
# OneViewDAG.fan_in('CREATE_BUSINESS_TABLE', 'CONCATENATE_IQVIA_BUSINESS_TABLE', 6)

# OneViewDAG.CONCATENATE_IQVIA_BUSINESS_TABLE \
OneViewDAG.CREATE_BUSINESS_TABLE \
...
OneViewDAG.LOAD_STATIC_REFERENCE_TABLE >> OneViewDAG.LOAD_IQVIA_BUSINESS_TABLE
OneViewDAG.LOAD_IQVIA_UPDATE_TABLE >> OneViewDAG.LOAD_IQVIA_BUSINESS_TABLE

# OneViewDAG.fan_out('CREATE_CLASS_OF_TRADE_TABLE', 'CREATE_BUSINESS_TABLE', 6)
# OneViewDAG.parallel('CREATE_BUSINESS_TABLE', 'LOAD_IQVIA_BUSINESS_TABLE', 6)
# OneViewDAG.sequence('LOAD_IQVIA_BUSINESS_TABLE', 6)
OneViewDAG.CREATE_CLASS_OF_TRADE_TABLE >> OneViewDAG.CREATE_BUSINESS_TABLE
OneViewDAG.EXTRACT_IQVIA_BUSINESS >> OneViewDAG.CREATE_BUSINESS_TABLE
OneViewDAG.CREATE_BUSINESS_TABLE >> OneViewDAG.LOAD_IQVIA_BUSINESS_TABLE
...
OneViewDAG.sequence('EXTRACT_CREDENTIALING_ORDER', 2)
OneViewDAG.EXTRACT_CREDENTIALING_ORDER_1 >> OneViewDAG.CONCATENATE_CREDENTIALING_ORDER \
