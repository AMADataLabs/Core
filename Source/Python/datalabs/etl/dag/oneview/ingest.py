...
class OneViewDAG(DAG):
    ...
    EXTRACT_IQVIA_BUSINESS: Repeat(JDBCExtractorTask, 4)
    CREATE_BUSINESS_TABLE: Repeat(IQVIABusinessTransformerTask, 4)
    CREATE_IQVIA_UPDATE_TABLE: IQVIAUpdateTransformerTask
    CONCATENATE_IQVIA_BUSINESS_TABLE: ConcatenateTransformerTask
    LOAD_IQVIA_BUSINESS_TABLE: Repeat(ORMLoaderTask, 4)
    ...
    EXTRACT_CREDENTIALING_ORDER: Repeat(JDBCExtractorTask, 4)
...
OneViewDAG.sequence('EXTRACT_IQVIA_BUSINESS', 4)
OneViewDAG.parallel('EXTRACT_IQVIA_BUSINESS', 'CREATE_BUSINESS_TABLE', 4)
OneViewDAG.fan_in('CREATE_BUSINESS_TABLE', 'CONCATENATE_IQVIA_BUSINESS_TABLE', 4)
...
OneViewDAG.fan_out('CREATE_CLASS_OF_TRADE_TABLE', 'CREATE_BUSINESS_TABLE', 4)
OneViewDAG.parallel('CREATE_BUSINESS_TABLE', 'LOAD_IQVIA_BUSINESS_TABLE', 4)
OneViewDAG.sequence('LOAD_IQVIA_BUSINESS_TABLE', 4)
...
OneViewDAG.sequence('EXTRACT_CREDENTIALING_ORDER', 4)
OneViewDAG.EXTRACT_CREDENTIALING_ORDER_3 >> OneViewDAG.CONCATENATE_CREDENTIALING_ORDER \
