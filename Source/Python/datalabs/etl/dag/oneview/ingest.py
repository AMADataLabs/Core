...
class OneViewDAG(DAG):
    ...
    EXTRACT_CREDENTIALING_ORDER: Repeat(JDBCExtractorTask, 8)
...
OneViewDAG.sequence('EXTRACT_CREDENTIALING_ORDER', 8)
OneViewDAG.EXTRACT_CREDENTIALING_ORDER_7 >> OneViewDAG.CONCATENATE_CREDENTIALING_ORDER \
