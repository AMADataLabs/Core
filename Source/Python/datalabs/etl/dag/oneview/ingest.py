...
class OneViewDAG(DAG):
    ...
    CREATE_NPI_TABLE: NPITransformerTask
...
OneViewDAG.EXTRACT_PARTY_KEYS >> OneViewDAG.CREATE_NPI_TABLE >> OneViewDAG.CREATE_PHYSICIAN_TABLE
...
OneViewDAG.EXTRACT_IQVIA >> OneViewDAG.CREATE_IQVIA_UPDATE_TABLE >> OneViewDAG.LOAD_IQVIA_UPDATE_TABLE_INTO_DATABASE
