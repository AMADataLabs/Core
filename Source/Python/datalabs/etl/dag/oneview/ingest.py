...
class OneViewDAG(DAG):
    ...
    EXTRACT_IQVIA_BUSINESS: Repeat(JDBCExtractorTask, 3)
    CREATE_BUSINESS_TABLE: Repeat(IQVIABusinessTransformerTask, 3)
    ...
    LOAD_IQVIA_BUSINESS_TABLE: Repeat(ORMLoaderTask, 5)
...
OneViewDAG.sequence('EXTRACT_IQVIA_BUSINESS', 3)
OneViewDAG.parallel('EXTRACT_IQVIA_BUSINESS', 'CREATE_BUSINESS_TABLE', 3)
OneViewDAG.fan_in('CREATE_BUSINESS_TABLE', 'CONCATENATE_IQVIA_BUSINESS_TABLE', 3)
...
OneViewDAG.fan_out('CREATE_CLASS_OF_TRADE_TABLE', 'CREATE_BUSINESS_TABLE', 3)

OneViewDAG.CONCATENATE_IQVIA_BUSINESS_TABLE >> OneViewDAG.SPLIT_IQVIA_BUSINESS_TABLE \
    >> OneViewDAG.LOAD_IQVIA_BUSINESS_TABLE_0
OneViewDAG.sequence('LOAD_IQVIA_BUSINESS_TABLE', 5)
