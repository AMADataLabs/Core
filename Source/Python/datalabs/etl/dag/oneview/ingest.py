...
class OneViewDAG(DAG):
    ...
    REFRESH_PHYSICIAN_INDEXES: ReindexerTask
    REFRESH_PROVIDER_VIEW: MaterializedViewRefresherTask
    REFRESH_PROVIDER_INDEXES: ReindexerTask
...
OneViewDAG.fan_out('SPLIT_PPD_TABLE', 'CREATE_PHYSICIAN_TABLE', 6)
OneViewDAG.fan_out('CREATE_PHYSICIAN_NPI_TABLE', 'CREATE_PHYSICIAN_TABLE', 6)
...
OneViewDAG.sequence('EXTRACT_IQVIA_BUSINESS', 5)
OneViewDAG.parallel('EXTRACT_IQVIA_BUSINESS', 'CREATE_BUSINESS_TABLE', 5)
OneViewDAG.fan_in('CREATE_BUSINESS_TABLE', 'CONCATENATE_BUSINESS_TABLE', 5)

OneViewDAG.CONCATENATE_BUSINESS_TABLE \
    >> OneViewDAG.CREATE_IQVIA_UPDATE_TABLE \
    >> OneViewDAG.LOAD_IQVIA_UPDATE_TABLE

OneViewDAG.LOAD_STATIC_REFERENCE_TABLE >> OneViewDAG.LOAD_BUSINESS_TABLE_0
OneViewDAG.LOAD_IQVIA_UPDATE_TABLE >> OneViewDAG.LOAD_BUSINESS_TABLE_0

OneViewDAG.fan_out('CREATE_CLASS_OF_TRADE_TABLE', 'CREATE_BUSINESS_TABLE', 5)

OneViewDAG.CONCATENATE_BUSINESS_TABLE >> OneViewDAG.LOAD_BUSINESS_TABLE_0
OneViewDAG.sequence('LOAD_BUSINESS_TABLE', 5)
...
OneViewDAG.fan_out('LOAD_CREDENTIALING_CUSTOMER_PRODUCT_TABLES', 'LOAD_CREDENTIALING_ORDER_TABLE', 12)
...
OneViewDAG.fan_in('LOAD_IQVIA_PROVIDER_AFFILIATION_TABLE', 'REFRESH_PHYSICIAN_VIEW', 6)
OneViewDAG.fan_in('LOAD_BUSINESS_TABLE', 'REFRESH_PHYSICIAN_VIEW', 5)
...
OneViewDAG.REFRESH_PHYSICIAN_VIEW >> OneViewDAG.REFRESH_PHYSICIAN_INDEXES
...
OneViewDAG.fan_in('LOAD_IQVIA_PROVIDER_AFFILIATION_TABLE', 'REFRESH_PROVIDER_VIEW', 6)
OneViewDAG.fan_in('LOAD_BUSINESS_TABLE', 'REFRESH_PROVIDER_VIEW', 5)
OneViewDAG.fan_in('LOAD_IQVIA_PROVIDER_TABLE', 'REFRESH_PROVIDER_VIEW', 3)
...
OneViewDAG.REFRESH_PROVIDER_VIEW >> OneViewDAG.REFRESH_PROVIDER_INDEXES
