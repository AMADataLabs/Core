...
class OneViewDAG(DAG):
    ...
    EXTRACT_CREDENTIALING_ORDER: Repeat(JDBCExtractorTask, 6)
...
OneViewDAG.sequence('EXTRACT_CREDENTIALING_ORDER', 6)
OneViewDAG.EXTRACT_CREDENTIALING_ORDER_5 >> OneViewDAG.CONCATENATE_CREDENTIALING_ORDER \
