...
OneViewDAG.CREATE_TYPE_OF_PRACTICE_TABLE >> OneViewDAG.LOAD_REFERENCE_TABLES_INTO_DATABASE
OneViewDAG.EXTRACT_PRESENT_EMPLOYMENT >> OneViewDAG.CREATE_PRESENT_EMPLOYMENT_TABLE
OneViewDAG.CREATE_PRESENT_EMPLOYMENT_TABLE >> OneViewDAG.LOAD_REFERENCE_TABLES_INTO_DATABASE
OneViewDAG.EXTRACT_CORE_BASED_STATISTICAL_AREA >> OneViewDAG.CREATE_CORE_BASED_STATISTICAL_AREA_TABLE
OneViewDAG.CREATE_CORE_BASED_STATISTICAL_AREA_TABLE >> OneViewDAG.LOAD_REFERENCE_TABLES_INTO_DATABASE
OneViewDAG.EXTRACT_FEDERAL_INFORMATION_PROCESSING_STANDARD_COUNTY >> OneViewDAG.\
    CREATE_FEDERAL_INFORMATION_PROCESSING_STANDARD_COUNTY_TABLE >> OneViewDAG.LOAD_REFERENCE_TABLES_INTO_DATABASE
OneViewDAG.EXTRACT_SPECIALTY >> OneViewDAG.REMOVE_UNUSED_SPECIALTIES >> OneViewDAG.LOAD_REFERENCE_TABLES_INTO_DATABASE
OneViewDAG.EXTRACT_RESIDENCY >> OneViewDAG.CREATE_RESIDENCY_PROGRAM_TABLES
OneViewDAG.CREATE_RESIDENCY_PROGRAM_TABLES >> OneViewDAG.LOAD_RESIDENCY_INSTITUTION_TABLE_INTO_DATABASE
OneViewDAG.LOAD_RESIDENCY_INSTITUTION_TABLE_INTO_DATABASE >> OneViewDAG.LOAD_RESIDENCY_TABLE_INTO_DATABASE
OneViewDAG.LOAD_RESIDENCY_TABLE_INTO_DATABASE >> OneViewDAG.LOAD_RESIDENCY_PERSONNEL_TABLE_INTO_DATABASE
OneViewDAG.CREATE_IQVIA_UPDATE_TABLE >> OneViewDAG.LOAD_IQVIA_UPDATE_TABLE_INTO_DATABASE
OneViewDAG.EXTRACT_IQVIA >> OneViewDAG.CREATE_BUSINESS_AND_PROVIDER_TABLES
OneViewDAG.CREATE_BUSINESS_AND_PROVIDER_TABLES >> OneViewDAG.LOAD_IQVIA_BUSINESS_PROVIDER_TABLES_INTO_DATABASE
OneViewDAG.LOAD_IQVIA_BUSINESS_PROVIDER_TABLES_INTO_DATABASE >> OneViewDAG.\
    LOAD_IQVIA_PROVIDER_AFFILIATION_TABLE_INTO_DATABASE
OneViewDAG.EXTRACT_CREDENTIALING >> OneViewDAG.CREATE_CREDENTIALING_CUSTOMER_PRODUCT_AND_ORDER_TABLES
OneViewDAG.EXTRACT_CREDENTIALING_ADDRESSES >> OneViewDAG.MERGE_CREDENTIALING_ADDRESSES_INTO_CUSTOMER_TABLE
OneViewDAG.LOAD_CREDENTIALING_CUSTOMER_PRODUCT_TABLES_INTO_DATABASE >> OneViewDAG.\
    LOAD_CREDENTIALING_ORDER_TABLE_INTO_DATABASE
OneViewDAG.EXTRACT_PHYSICIAN_RACE_ETHNICITY >> OneViewDAG.CREATE_PHYSICIAN_TABLE
...
OneViewDAG.CREATE_PHYSICIAN_TABLE >> OneViewDAG.LOAD_PHYSICIAN_TABLE_INTO_DATABASE
OneViewDAG.EXTRACT_HISTORICAL_RESIDENCY >> OneViewDAG.CREATE_PHYSICIAN_TABLE
OneViewDAG.CREATE_PHYSICIAN_TABLE >> OneViewDAG.LOAD_PHYSICIAN_TABLE_INTO_DATABASE
>>>>>>> 6963d54f5d3c813b5831891054a4b15f4beded3d
