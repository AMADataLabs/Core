...
initialize_tasks_file() {
    tasks=(
        ...
        "EXTRACT_IQVIA_BUSINESS_0"
        "EXTRACT_IQVIA_BUSINESS_1"
        "EXTRACT_IQVIA_BUSINESS_2"
        "CREATE_BUSINESS_TABLE_0"
        "CREATE_BUSINESS_TABLE_1"
        "CREATE_BUSINESS_TABLE_2"
        "CONCATENATE_IQVIA_BUSINESS_TABLE"
