...
def main(args):
    ...
    init_pred_dir = 'U:\\Source Files\\Data Analytics\\Data-Science\\Data\\Phone_Quality_Model\\Analysis\\'
    wslive_pred_sample_file = filedialog.askopenfilename(initialdir=init_pred_dir,
                                                         title="Choose wslive file with predictions...")

    init_anlys_dir = 'U:\\Source Files\\Data Analytics\\Data-Science\\Data\\Phone_Quality_Model\\Analysis\\'
    ...
    log_filename = anlys_out_dir + date_range_str + '_WSLive_PhoneQuality_Scoring_Analysis_Log.txt'
    ...
    wslive_pred_sample_df = wslive_pred_sample.datalabs.rename_in_upper_case()
    ...
    bin_save_file = anlys_out_dir + date_range_str + '_WSLive_PhoneQuality_Bin_Analysis.xlsx'
