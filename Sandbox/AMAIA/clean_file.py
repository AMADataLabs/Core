...
def clean_file(insurance, usage):
    ...
    missing_addresses = all_that[(nones.ADDR_2_y=='None')&(nones.ADDR_1_y=='None')&(nones.ADDR_3_y!='None')]
    ...
    col = get_columns()
    all_that = all_that[['ME', 'SRC_POST_KEY','usage','load_type_ind','addr_type',
       'ADDR_1_y', 'ADDR_2_y',
       'ADDR_3_y', 'CITY_y', 'STATE_CD_y', 'ZIP_y', 'source', 'source_dtm']].rename(columns=col)
