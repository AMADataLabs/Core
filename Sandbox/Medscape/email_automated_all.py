...
file3 = f'{OUT_DIRECTORY}\\Memorium_USA_Physicians_{TODAY}.xlsx'
file4 = f'{OUT_DIRECTORY}\\Memorium_USA_ME_{TODAY}.xlsx'
...
file9 = f'{OUT_DIRECTORY}\\COUNTRY_{TODAY}.png'
file10 = f'{OUT_DIRECTORY}\\Memorium_USA_Delta_{TODAY}.csv'
file11 = f'{OUT_DIRECTORY}\\Memorium_World_Delta_{TODAY}.csv'
...
full = ['Nicole.Neal@ama-assn.org','Tammy.Weaver@ama-assn.org', 'Derek.Smart@ama-assn.org','victoria.grose@ama-assn.org','sandeep.dhamale@ama-assn.org']
...
def send_email(recipients= full, cc=['nikhil.khatri@ama-assn.org'],
               ...
               attachments=[file1, file2, file3, file4, file5, file6, file7, file8, file9, file10, file11], auto_send=True):
