...
model_file = filedialog.askopenfilename(initialdir = "U:\\Source Files\\Data Analytics\\Data-Science\\Data\\Phone_Disconnect_Model\\",
                                         title = "Choose the current phone disconnect model sav file...")

# Get model file needed
model_var_file = filedialog.askopenfilename(title = "Choose the current phone disconnect model feature list sav file...")
...
init_save_dir = 'U:\\Source Files\\Data Analytics\\Data-Science\\Data\\Phone_Disconnect_Model\\'
...
ppd_entity_file = ppd_archive_dir + start_time_str + '_PPD_' + ppd_date_str + '_Phone_Disconnect_PPD_Entity_Data.csv'
...
ppd_dpc_output_file = ppd_score_out_dir + 'Phone_Disconnect_Scored_PPD_DPC_Pop.csv'
model_pred_df.to_csv(ppd_dpc_output_file, sep = ',', header = True, index = True)

archived_output_file = ppd_archive_dir + start_time_str + '_PPD_' + ppd_date_str + '_Phone_Disconnect_Scored_PPD_DPC_Pop.csv'
model_pred_df.to_csv(archived_output_file, sep = ',', header = True, index = True)

model_input_file = ppd_archive_dir + start_time_str + '_PPD_' + ppd_date_str + '_Phone_Disconnect_Input_Data.csv'
