...
def get_ent_counts(entity_phn_df, id_phn_var, all_phn_var, ent_id_var, phone_var):
    ...
    ent_id_phn_count_df = get_ent_phn_counts(entity_phn_df, [ent_id_var, phone_var], 
                                                    id_phn_var)
...
def create_ent_comm_data(ent_comm_df, phone_df, ent_key_df, phone_var):
    ...
    entity_phn_df = entity_phn_df.merge(ent_key_df, how = 'inner', left_on = 'ent_comm_entity_id', 
                                       right_on = 'entity_id')
...
def create_ent_usg_data(ent_comm_usg_df, phone_df, ent_key_df, phone_var):
    ...
    entity_usg_phn_df = create_combined_phn_ent_data(ent_comm_usg_df, phone_df, 'usg_comm_id',
                                                   'phn_comm_id')
    ...
    entity_usg_phn_df = entity_usg_phn_df.merge(ent_key_df, how = 'inner', left_on = 'usg_entity_id', 
                                       right_on = 'entity_id')
...
def join_ent_comm_count_data(ent_date_df, ent_id_phn_count_df, ent_all_phn_count_df, 
    ...
    ent_date_df = ent_date_df.merge(ent_id_phn_count_df, how = 'left',
                                                 on = ['ent_comm_entity_id', phone_var])
    ent_date_df = ent_date_df.merge(ent_all_phn_count_df, how = 'left', 
                                                 on = [phone_var])
...
def get_ent_lic_data(ent_date_df, license_df, date_var, state_var):
    ...
    lic_ent_dt_df = lic_notnull_df.merge(ent_date_df[['ent_comm_entity_id', date_var]], how = 'inner', 
                                            left_on = 'entity_id', right_on = 'ent_comm_entity_id')
...
def get_fone_lic_data(ent_date_df, fone_zr_df, lic_filter_df):
    ...
    fone_ent_dt_df = ent_date_df.merge(fone_zr_df, how = 'inner', 
                                            left_on = 'phn_area_cd', right_on = 'FNZR_AREA_CD')
...
def create_phn_entity_data(ent_comm_df, ent_comm_usg_df, phone_df, ent_key_df,
    ...
    entity_phn_df = entity_phn_df.merge(date_df, how = 'inner', left_on = 'ent_me', 
    ...
    entity_usg_phn_df = entity_usg_phn_df.merge(date_df, how = 'inner', left_on = 'ent_me', 
                                                right_on = date_me_var)
