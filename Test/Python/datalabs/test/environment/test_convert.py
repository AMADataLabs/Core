...
def test_dependency_dict_matches_conda_package_list(conda_package_list_filename, expected_conda_packages):
    ...
    dependencies = converter._read_conda_dependencies(cls, conda_package_list_filename)
...
def conda_package_list_filename():
    return 'Test/datalabs/environment/conda_package_list.txt'


@pytest.fixture
def pipfile_template_filename():
    return 'Test/datalabs/environment/Pipfile_template.txt'
