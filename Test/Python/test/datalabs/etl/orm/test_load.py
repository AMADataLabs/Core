...
def test_orm_loader(components):
    ...
    components.variables['CLASS'] = 'datalabs.etl.orm.loader.ORMLoader'
...
def environment(extractor_file, loader_directory):
    ...
    os.environ['LOADER_CLASS'] = ' datalabs.etl.orm.load'
    os.environ['LOADER_DATABASE_NAME'] = 'oneview'
    os.environ['LOADER_DATABASE_BACKEND'] = 'postgresql+psycopg2'
    os.environ['LOADER_DATABASE_HOST'] = '10.104.16.31'
    os.environ['LOADER_DATABASE_USERNAME'] = 'postgres'
    os.environ['LOADER_DATABASE_PASSWORD'] = 'datalabs'
    os.environ['LOADER_TABLES'] = 'physician'
