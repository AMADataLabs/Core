...
class DagNotifierTests {
    protected static final Logger LOGGER = LoggerFactory.getLogger(DagNotifierTests.class);
    ...
    void notifySucceeds() {
        try {
            DagNotifier notifier = new DagNotifier(DagNotifierTests.DAG_TOPIC_ARN);
