...
def upgrade():
    ...
    op.drop_entity(oneview_mat_phy_pro_view)
...
def downgrade():
    ...
    op.create_entity(oneview_mat_phy_pro_view)
    ...
    op.create_entity(oneview_mat_phy_view)
